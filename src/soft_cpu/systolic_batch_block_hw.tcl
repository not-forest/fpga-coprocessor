...
# Thu Nov 06 12:21:22 UTC 2025
# DO NOT MODIFY


# 
# systolic_batch_block "systolic_batch_block" v1.0
# notforest 2025.11.06.12:21:22
...
# parameters
# 
add_parameter g_DIMENSION NATURAL 8
set_parameter_property g_DIMENSION DEFAULT_VALUE 8
set_parameter_property g_DIMENSION DISPLAY_NAME g_DIMENSION
set_parameter_property g_DIMENSION TYPE NATURAL
set_parameter_property g_DIMENSION UNITS None
set_parameter_property g_DIMENSION ALLOWED_RANGES 0:2147483647
set_parameter_property g_DIMENSION HDL_PARAMETER true
...
add_interface_port avalon av_address address Input 6
...
add_interface_port conduit i_rd_clk i_rd_clk Input 1
add_interface_port conduit i_rd_row i_rd_row Input 3
add_interface_port conduit o_data o_data Output 8
add_interface_port conduit i_rd_col i_rd_col Input 3
add_interface_port conduit o_sticky o_sticky Output 8
