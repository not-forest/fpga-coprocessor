...
# Sat Nov 29 21:43:28 UTC 2025
# DO NOT MODIFY


# 
# systolic_serializer "systolic_serializer" v1.0
# notforest 2025.11.29.21:43:28
# 
# 
...
# 
# module systolic_serializer
# 
set_module_property DESCRIPTION ""
set_module_property NAME systolic_serializer
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Bridges and Adapters/Memory Mapped"
set_module_property AUTHOR notforest
set_module_property DISPLAY_NAME systolic_serializer
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avalon_serializer
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avalon_serializer.vhd VHDL PATH ../avalon_serializer.vhd TOP_LEVEL_FILE
add_fileset_file serializer.vhd VHDL PATH ../intrinsics/serializer.vhd
add_fileset_file types.vhd VHDL PATH ../intrinsics/types.vhd
add_fileset_file pe_fifo.vhd VHDL PATH ../intrinsics/pe_fifo.vhd
...
add_interface_port conduit i_acc i_acc Input 32
add_interface_port conduit o_clr o_clr Output 1
add_interface_port conduit i_rx_ready i_rx_ready Input 1
add_interface_port conduit o_iterations o_iterations Output 32
add_interface_port conduit o_iterations_write o_iterations_write Output 1
add_interface_port conduit o_rx_ready o_rx_ready Output 1
...
add_interface_port reset ni_clr reset_n Input 1
...
add_interface_port avalon av_address address Input 1
add_interface_port avalon av_write write Input 1
add_interface_port avalon av_read read Input 1
add_interface_port avalon av_writedata writedata Input 32
add_interface_port avalon av_readdata readdata Output 32
