...
mkdir -p ./libraries/DEBUG_JTAG_avalon_jtag_slave_agent_rsp_fifo/
mkdir -p ./libraries/DEBUG_JTAG_avalon_jtag_slave_agent/
mkdir -p ./libraries/CPU_data_manager_agent/
mkdir -p ./libraries/DEBUG_JTAG_avalon_jtag_slave_translator/
mkdir -p ./libraries/CPU_data_manager_translator/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                -work DEBUG_JTAG_avalon_jtag_slave_agent_rsp_fifo -cdslib ./cds_libs/DEBUG_JTAG_avalon_jtag_slave_agent_rsp_fifo.cds.lib
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                           -work DEBUG_JTAG_avalon_jtag_slave_agent          -cdslib ./cds_libs/DEBUG_JTAG_avalon_jtag_slave_agent.cds.lib         
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                    -work DEBUG_JTAG_avalon_jtag_slave_agent          -cdslib ./cds_libs/DEBUG_JTAG_avalon_jtag_slave_agent.cds.lib         
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                          -work CPU_data_manager_agent                      -cdslib ./cds_libs/CPU_data_manager_agent.cds.lib                     
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                      -work DEBUG_JTAG_avalon_jtag_slave_translator     -cdslib ./cds_libs/DEBUG_JTAG_avalon_jtag_slave_translator.cds.lib    
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                     -work CPU_data_manager_translator                 -cdslib ./cds_libs/CPU_data_manager_translator.cds.lib                
  ...
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/coproc_soft_cpu_SPI_0.vhd"                                              -work SPI_0                                       -cdslib ./cds_libs/SPI_0.cds.lib                                      
